...
import { RankingPropNoIndex } from "../ui/ranking";
...
export default function Global() {
    ...
    //
    let dataset: RankingPropNoIndex[] = [
        {
            id: "11",
            name: "Elma",
            href: "/detail"
    ...
    return (
        <div id='global-container' className="flex flex-col gap-4 pt-12">
            <SortableContainer editable={false} sorted={true} activeId={undefined} activeElement={undefined} dataLength={dataCount} dataArray={dataset}></SortableContainer>
        </div>
    )
}